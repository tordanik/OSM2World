...
import org.osm2world.target.common.material.RuntimeTexture;
...
import org.osm2world.target.common.texcoord.GlobalXZTexCoordFunction;
import org.osm2world.target.frontend_pbf.FrontendPbf.*;
import org.osm2world.target.frontend_pbf.FrontendPbf.Animation.AnimationType;
import org.osm2world.target.frontend_pbf.FrontendPbf.Material.TextureLayer;
import org.osm2world.target.frontend_pbf.FrontendPbf.Material.TextureLayer.TexCoordFunction;
import org.osm2world.target.frontend_pbf.FrontendPbf.Material.TextureLayer.Wrap;
import org.osm2world.target.frontend_pbf.FrontendPbf.Material.Transparency;
import org.osm2world.target.frontend_pbf.FrontendPbf.Shape.ShapeType;
...
public class FrontendPbfTarget extends MeshTarget {
	...
	private FrontendPbf.Material convertMaterial(Material material) {
		...
		for (org.osm2world.target.common.material.TextureLayer textureLayer : material.getTextureLayers()) {
	...
	private TextureLayer convertTextureLayer(org.osm2world.target.common.material.TextureLayer textureLayer) {
