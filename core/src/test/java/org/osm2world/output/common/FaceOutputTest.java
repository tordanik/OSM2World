...
import org.osm2world.output.common.FaceOutput.Face;
import org.osm2world.output.common.FaceOutput.IsolatedTriangle;


public class FaceOutputTest {
	...
	public void testCombineTrianglesToFaces() {
		...
		Collection<Face> faces =
				FaceOutput.combineTrianglesToFaces(isolatedTriangles);
