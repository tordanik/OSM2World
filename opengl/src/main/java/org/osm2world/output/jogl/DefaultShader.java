...
public class DefaultShader extends AbstractPrimitiveShader {
	...
	public boolean setMaterial(Material material, JOGLTextureManager textureManager) {
		...
		gl.glUniform1f(gl.glGetUniformLocation(shaderProgram, "Material.Ka"), AbstractJOGLOutput.AMBIENT_FACTOR);
		gl.glUniform1f(gl.glGetUniformLocation(shaderProgram, "Material.Kd"), 1 - AbstractJOGLOutput.AMBIENT_FACTOR);
		gl.glUniform1f(gl.glGetUniformLocation(shaderProgram, "Material.Ks"), AbstractJOGLOutput.SPECULAR_FACTOR);
		gl.glUniform1i(gl.glGetUniformLocation(shaderProgram, "Material.Shininess"), AbstractJOGLOutput.SHININESS);
