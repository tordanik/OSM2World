...
import static org.osm2world.output.common.material.Material.Transparency.BINARY;
import static org.osm2world.output.common.material.Material.Transparency.TRUE;
 ...
 */
public final class JOGLOutputFixedFunction extends AbstractJOGLOutput implements JOGLOutput {
	 ...
	 */
	public JOGLOutputFixedFunction(GL2 gl, JOGLRenderingParameters renderingParameters,
	...
	public void renderPart(Camera camera, Projection projection,
		...
		for (NonAreaPrimitive nonAreaPrimitive : nonAreaPrimitives) {
			...
			gl.glBegin(AbstractJOGLOutput.getGLConstant(nonAreaPrimitive.type));
