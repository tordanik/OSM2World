...
/**
 * Common implementation base for the new shader based {@link JOGLOutputShader} and the old {@link JOGLOutputFixedFunction}
 */
public abstract class AbstractJOGLOutput extends PrimitiveOutput implements JOGLOutput {
	...
	public AbstractJOGLOutput(GL gl, JOGLRenderingParameters renderingParameters,
	...
	protected void drawPrimitive(Primitive.Type type, Material material,
		...
		if (!material.textureLayers().isEmpty()) {
			for (TextureLayer layer : material.textureLayers()) {
